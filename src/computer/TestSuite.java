    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
      ...
      clickOnElement(By.xpath("//div[@class='bar-notification success']/span"));
       ...
       clickOnElement(By.xpath("//input[@name='termsofservice']"));
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Mani");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Meghji");
        sendTextToElement(By.id("BillingNewAddress_Email"), "mani123@gmail.com");
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='BillingNewAddress_CountryId']"), "United Kingdom");
        sendTextToElement(By.id("BillingNewAddress_City"), "London");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "29 Talbot Road");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "HA04UG");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07788990011");
        //lick on “CONTINUE”
        Thread.sleep(1000);
